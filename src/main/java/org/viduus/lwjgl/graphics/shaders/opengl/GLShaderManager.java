...
public class GLShaderManager extends ShaderManager {
	...
	public GLShaderManager(ShaderLoader loader) {
		super(loader);
	}
	 ...
	 */
	@Override
	protected ShaderProgram load(String shader_name) throws IOException {
		return new GLShaderProgram(shader_name, this, new GlVariableInterface());
	}
