...
import org.viduus.lwjgl.graphics.shaders.core.*;
...
public class GLShaderProgram extends ShaderProgram {
	 ...
	 */
	@Override
	protected ShaderSource loadSource(String shader_name, ShaderType type) throws IOException {
		return new GLShaderSource(this, shader_name, type);
	}
